...
export class VariableBatcher {
  ...
  // Known tokens from constitution (for accurate snapshots)
  private readonly knownTokens: Set<string> = new Set([
    // Color tokens
    "--gray-50", "--gray-100", "--gray-200", "--gray-300", "--gray-400",
    "--gray-500", "--gray-600", "--gray-700", "--gray-800", "--gray-900", "--gray-950",
    "--accent-bg", "--accent-bg-hover", "--accent-bg-active", "--accent-subtle", "--accent-fg",
    "--color-accent", "--color-accent-hover", "--color-accent-active", "--color-accent-subtle", "--color-accent-foreground",
    "--success", "--success-light", "--warning", "--warning-light", "--error", "--error-light", "--info", "--info-light",
    "--bg-base", "--bg-subtle", "--bg-muted", "--bg-elevated", "--bg-overlay",
    "--fg-primary", "--fg-secondary", "--fg-tertiary", "--fg-quaternary", "--fg-inverse",
  ...
  public beginTransaction(): void {
    if (this.transactionActive) {
      throw new Error("Transaction already active. Call commitTransaction() or rollbackTransaction() first.");
    }
   ...
   */
  public queueUpdates(updates: Record<string, string>, priority: number = 0): void {
