...
const tooltipVariants = {
  ...
  variants: {
    ...
    size: {
      sm: `px-[${spacingTokens.sm}] py-[${spacingTokens.xs}] ${typographyTokens.sm}`,
      md: `px-[${spacingTokens.md}] py-[${spacingTokens.sm}] ${typographyTokens.base}`,
      lg: `px-[${spacingTokens.lg}] py-[${spacingTokens.md}] ${typographyTokens.base}`,
    },
  },
}
